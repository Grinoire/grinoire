...
CREATE TABLE can(
        role_id_fk   Int NOT NULL ,
        action_id_fk Int NOT NULL ,
        PRIMARY KEY (role_id_fk ,action_id_fk)
)ENGINE=InnoDB;

ALTER TABLE card ADD CONSTRAINT FK_card_type_id FOREIGN KEY (type_id_fk) REFERENCES type(type_id);
ALTER TABLE card ADD CONSTRAINT FK_card_deck_id FOREIGN KEY (deck_id_fk) REFERENCES deck(deck_id);
ALTER TABLE user ADD CONSTRAINT FK_user_deck_id FOREIGN KEY (deck_id_fk) REFERENCES deck(deck_id);
ALTER TABLE user ADD CONSTRAINT FK_user_role_id FOREIGN KEY (role_id_fk) REFERENCES role(role_id);
ALTER TABLE user ADD CONSTRAINT FK_user_game_id FOREIGN KEY (game_id_fk) REFERENCES game(game_id);
ALTER TABLE user ADD CONSTRAINT FK_user_tmp_hero_id FOREIGN KEY (tmp_hero_id_fk) REFERENCES tmp_hero(tmp_hero_id);
ALTER TABLE tmp_card ADD CONSTRAINT FK_tmp_card_user_id FOREIGN KEY (user_id_fk) REFERENCES user(user_id);
ALTER TABLE tmp_hero ADD CONSTRAINT FK_tmp_hero_user_id FOREIGN KEY (user_id_fk) REFERENCES user(user_id);
ALTER TABLE can ADD CONSTRAINT FK_can_role_id FOREIGN KEY (role_id_fk) REFERENCES role(role_id);
ALTER TABLE can ADD CONSTRAINT FK_can_action_id FOREIGN KEY (action_id_fk) REFERENCES action(action_id);
